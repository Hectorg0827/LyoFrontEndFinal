  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Text style={[styles.tabText, activeTab === 'saved' && styles.activeTabText]}>Saved by You</Text>
        </TouchableOpacity>
        <TouchableOpacity 
      ...
      <ScrollView style={styles.content}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.itemsRow}>
                {collections.map(collection => (
                  <TouchableOpacity key={collection.id} style={styles.collectionCard}>
                    ...
                    >
                      <Image source={{ uri: collection.coverUrl }} style={styles.collectionImage} />
        ...
        {activeTab === 'for-you' && (
          <View style={styles.emptyStateContainer}>
            ...
            <Text style={styles.emptyStateText}>Explore more content to get personalized recommendations based on your learning interests.</Text>
            ...
            <View style={styles.progressList}>
              {savedItems.map(item => (
                <TouchableOpacity key={item.id} style={styles.progressItem}>
                  <Image source={{ uri: item.imageUrl }} style={styles.progressItemImage} />
                  <View style={styles.progressItemDetails}>
                    ...
                    {item.progress && (
                      <View style={styles.inlineProgressContainer}>
                        <View style={[styles.inlineProgressBar, { width: `${item.progress * 100}%` }]} />
        ...
        {activeTab === 'collections' && (
          <View style={styles.collectionsGrid}>
            {collections.map(collection => (
              <TouchableOpacity key={collection.id} style={styles.collectionGridCard}>
                <LinearGradient
                  colors={['rgba(0,0,0,0.3)', 'rgba(0,0,0,0.8)']}
                  style={styles.collectionGridGradient}
                >
                  <Image source={{ uri: collection.coverUrl }} style={styles.collectionGridImage} />
